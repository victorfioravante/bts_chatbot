...
(function () {
  ...
  // ─── Default word lists ────────────────────────────────────────────────────
  const DEFAULTS = {
    casino_terms:     ["Ace","Ante","Baccarat","Banker","Bet","Blind","Bluff","Bonus","Bust","Call","Card","Casino","Check","Chip","Croupier","Cut","Deal","Dealer","Deck","Double","Down","Draw","Edge","Flush","Fold","Full","Gamble","Hand","Hit","Hold","Hole","House","Insurance","Jackpot","Joker","Keno","Limit","Loose","Martingale","Match","Maximum","Minimum","Natural","Odds","Pair","Pass","Player","Poker","Pot","Push","Raise","Rake","Random","River","Roll","Roulette","Royal","Shoe","Shuffle","Slot","Spin","Split","Stake","Stand","Straight","Street","Table","Tie","Token","Trip","Turn","Variance","Wager","Wild","Win","Zero"],
    bitsler_terms:    ["Rain","Drizzle","Chat","Wager","Bet","Spin","Roll","Dice","Crash","Limbo","Plinko","Wheel","Hilo","Mines","Keno","Baccarat","Roulette","Slots","Poker","Jackpot","Bonus","Promo","VIP","Rank","Level","Points","Wagering","Deposit","Withdraw","Tip","Faucet","Challenge","Tournament","Prize","Affiliate","Referral","Code","Balance","Currency","Multiplier","Odds","House","Edge","Provably","Fair","Seed","Hash","Nonce","Verify","Result","Win","Lose","Profit","Strategy","Martingale","Fibonacci","Paroli","Dalembert","Support","Moderator","Admin","Ban","Mute","Warning"],
    blockchain_terms: ["ABI","API","APR","APY","Asic","Asset","Atomic","Analytics","Algorithm","Bot","BTC","Burn","Block","Bridge","Bitcoin","CEX","Coin","Chain","Custody","Currency","Consensus","Cryptography","DAO","Data","DApp","DeFi","Dealer","Demand","Digital","Deposit","Database","Distributed","Decentralization","Escrow","Ethereum","Exchange","Encryption","Fee","Fiat","Fork","Faucet","Finance","Finality","Gas","Hash","Hodl","Hold","Halving","ICO","Immutable","Inflation","Investing","Insurance","Interoperability","Key","KYC","Ledger","Liquidity","Mint","Miner","Mining","Market","NFT","Node","Nonce","Network","Oracle","Plasma","Protocol","Reward","Satoshi","Staking","Storage","Support","Sharding","Security","Solidity","Strategy","Scalability","Supply","Token","Trading","Transfer","Transaction","Tokenization","Validator","Validation","Volatility","Whale","Wallet","Withdraw"],
